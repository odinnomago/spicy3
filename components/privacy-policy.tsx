      ...
      <div className="container mx-auto px-4 space-y-12">
        ...
        <Card className="bg-dark-900 border-gray-800 text-center">
          <CardContent className="text-gray-300 text-lg leading-relaxed p-6">
            ...
            <p>
              <strong className="text-green-400">Ao utilizar a Spicy Models, você confirma ter lido, entendido e aceito integralmente nossa Política de Privacidade.</strong>
            </p>
          </CardContent>
        </Card>
      </div>
